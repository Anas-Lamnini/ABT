...
<!--<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img style="background-color:#B6F5B5; height:20px;">
      <div class="carousel-caption">
      <div style="border:solid;">
        <h1 class="display-2" style="font-size:100px; text:underline;" >EDIT FILE</h1>
      </div>
    </div></div>   
  </div> 
</div>-->
...
<ul class="breadcrumb" style="width:100%;">
  ...
  <li><a class="text-secondary" href="Visualisation" style="font-size:20px;">Edit File</a></li>
</ul>
...
<div class="col-md-12" >
      ...
      {{method_field('PUT')}}
            ...
            <div class="form-group">
                <label class="text-secondary" style="font-size:40px; font-weight:bold;">Description :</label><hr>
